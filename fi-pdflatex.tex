...
We have found a solution thanks to an American Mock Trial Association.

- not possible to gather real trial cases, not accessible and if so, problem with privacy
- 20x case from which:
2x School environment - educational malpractice or indifference
1x Bullying - intentional infliction of emotional distress
2x Criminal law - assault, battery or murder
3x Inmate partner violence - domestic violence by a current or former partner
3x First Amendment - breach of freedom of speech, religion, press etc.
4x Child neglect - child injury or death caused by parents, baby-sitter or teacher
2x Sex crime - sexual harassment and disease transmissions
3x Tort law - fault leading to suffer or harm
