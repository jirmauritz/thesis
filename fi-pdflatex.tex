...
\thesissetup{
    ...
    keywords      = {electronic discovery, machine learning, legal domain, natural language processing},
    TeXkeywords   = {electronic discovery, machine learning, legal domain, natural language processing},
    abstract      = {The thesis focuses on automation of electronic discovery by predicting the relevance of legal documents.
    The first contribution of this thesis is a description and understanding of the legal data characteristics and research of the most suitable classification algorithm for the relevance prediction.
    The second contribution is a design and implementation of a system for automatic classification of legal documents, which applies the knowledge from this research.
    The system is integrated with the Legato system, which is a collaborative system for documents management that provides comprehensive control over legal cases.},
    thanks        = {I would like to thank RNDr. Zuzana Nevěřilová, Ph.D. for her support, precious pieces of advice and professional guidance. Special thanks also go to Ing. Libor Kubečka for the technical guidance, valuable discussions, and patience. Finally, I would like to thank my family and friends for the support during all my studies.},
    bib           = example.bib,
}
...
Despite all the effort, lawyers were quite skeptical about AI helping in the legal domain, as can be seen in the article \citetitle{oskamp2002ainotsomuch} by \citeauthor{oskamp2002ainotsomuch} (\citeyear{oskamp2002ainotsomuch}) \cite{oskamp2002ainotsomuch}.
...
The paper \citetitle{thompson2001automatic} compares three algorithms for legal document classification: k-NN, decision tree algorithm, and a rule induction algorithm Ripper \cite{thompson2001automatic}.
...
The rules include \textit{Part-of-Speech Tagging}\footnote{Detailed information about POS Tagging can be found in chapter 10 of \citetitle{jurafsky2014speech} by \citeauthor{jurafsky2014speech} \cite{jurafsky2014speech}}
...
We will introduce the first two of them\footnote{For more detailed description, see \citetitle{jurafsky2014speech} \cite{jurafsky2014speech}.}.
...
As an example, a thesis \citetitle{Machovec2015thesis} by \citeauthor{Machovec2015thesis} conducts a study on the automatic text summarization based on the relevant sentences \cite{Machovec2015thesis}.
...
% 0.733, 0.733, 0.733, 0.745, 0.749, 0.737, 0.726, 0.756, 0.726, 0.722 - without label
% 0.745, 0.749, 0.749, 0.749, 0.741, 0.768, 0.722, 0.737, 0.726, 0.745 - with label
% with label mean 0.743, and CI 0.735 - 0.751
% without  label mean 0.736, and CI 0.729 - 0.742
