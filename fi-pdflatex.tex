...
We evaluated results based on analysis of our use-case and on a survey, in which participants labeled features from the text in a similar way as a NLP tool.
