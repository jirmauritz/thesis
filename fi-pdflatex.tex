...
% 17.7 % of sentences are relevant
...
\label{fig:api}
\begin{tabular}{|m{2cm}|p{5.5cm}|p{5cm}|}
\hline
\rowcolor{gray!30}
\textbf{Method}        & \textbf{Endpoint}   & \textbf{Description}   \\[10pt] \hline
...
DELETE  & /case/\{\textit{caseId}\} & Deletes the specified case.  \\ \hline
...
DELETE  & /case/\{\textit{caseId}\}/doc/\{\textit{docId}\} & Deletes the specified document. \\ \hline
...
The data models include Case, Doc, Sentence, Feature, Entity, Keyword, and Comment.
...
% 2. try evaluate some short passages from document and show concrete examples how it works
