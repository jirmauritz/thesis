...
As the Data Characteristics chapter (\ref{chp:data_characteristics}) loosely defines the classes, the following paragraphs provide more specific and statistical definition.
