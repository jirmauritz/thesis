...
\thesissetup{
    ...
    abstract      = {The thesis focuses on an automation of electronic discovery by predicting relevance of legal documents.
    The first contribution of this thesis is a description and understanding of the legal data characteristics and a research of the most suitable classification algorithm for the relevance prediction.
    ...
    thanks        = {I would like to thank RNDr. Zuzana Nevěřilová, Ph.D. for her support, precious advices and professional guidance. Great thanks also belongs to Ing. Libor Kubečka for the technical guidance, valuable discussions, and patience. Finally, I would like to thank to my family and friends for the support during all my studies.},
    bib           = example.bib,
}
...
% 1. print precision and recalls for model with merged WARM and HOT
