...
This chapter summarizes the previous work generally on the artificial intelligence in the legal domain, retrieval of the legal documents, and issue of relevance in the legal context.
Many researchers have been concerned with the issue of auto
...
At the turn of the century, an attempt to conceptualize the legal domain brought a number of ontologies, such as McCarty's language for legal discourse, Stamper's norma formalism or Valente's functional ontology \cite{Visser1998ontologies}.
...
In any case, the conclusion of the research comparing four main ontologies for the design of legal knowledge systems is
``Non  of  the  ontologies  seems  to  have  adequate  provisions  to  specify  legal procedures'' \cite{Visser1998ontologies}.



% paper: Automated patent landscaping
