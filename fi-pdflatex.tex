...
First section presents the NLP features encoded into attributes applicable to the models.
Next sections describe the models predicting relevance.
...
Each of them needs a different set of attributes as an input and applies different machine learning model.
...
This section introduces the model that directly processes the extracted embeddings explained in the previous section and predict the class.



% popsat proc jsem zvolil NN - kvuli prirozenemu prostredi word2vec
% popsat nejlepsi parametry, optimizer

% popsat ze jsem zkusil LSTM na vsechny slova dokumentu, ale nevyslo

% popsat ze jsem zkusil pouzit features primo z celeho dokumentu, ale uspesnost byla nizsi nez pri pouziti vet

\section{Law-Case classifier}
\label{sec:law-case-classifier}
% ted je jasne co pouzivam na ziskani predpovedi z jednotlivych featur - cisla z NN
% napsat ktere z feature jsem pouzil a jak zkombinoval
