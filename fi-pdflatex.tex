...
Each of them needs different set of attributes as an input and applies suitable machine learning model.
...
This solution has been improved by counting the words in the training documents, TF-IDF weighting or co-occurrence matrices \cite{wordEmbeddings}.

The third and final solution goes even further in the embedding of the meaning.
...
Each element of the vector represents some concept, which can be somehow quantified, such as masculinity, age or liveliness \cite{mikolov2013linguistic}.
...
In this embeddings, the assumption that close vectors are close by the meaning of the underlying words as well, is true.
...
The pre-trained model contains 3 million unique words of 300-dimensional vectors, which was trained on the 300 billion word news dataset.
For our purpose, a trimmed dataset of 300 thousand words without the phrases is sufficient \footnote{\url{https://github.com/eyaler/word2vec-slim}}.
